...
function generateCurse() {
	...
	var triggers = [
		...
		},
		{
			...
			sets: [determinesRandomSex, triggerSexBecomesOppositeSubjectSex, subjectIsLiving, subjectMustDetermineSex, subjectTransformation, replacesGenitals, subjectInhuman]
		},
		{
